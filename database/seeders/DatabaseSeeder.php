...
class DatabaseSeeder extends Seeder
{
    ...
    public function seedCatalog()
    {
        ...
        foreach($this->arrayPeliculas as $p){
            ...
            $pelicula->year = $p['year'];
            $pelicula->director = $p['director'];
            $pelicula->poster = $p['poster'];
            $pelicula->rentada = $p['rentada'];
    ...
    private $arrayPeliculas = array(
		array(
			...
			'poster' => 'http://www.todojuegos.com/modules/coppermine/albums/userpics/10002/GODFgenPFT.jpg',
			'rentada' => false,
